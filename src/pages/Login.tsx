...
const Login: React.FC = () => {
  return (
    <div
      className="flex items-center justify-center min-h-screen w-full bg-cover   bg-center flex-col"
    ...
    >
      ...
      {/* Login Card */}
      <div className="bg-[#307AA8] shadow-2xl mt-4 py-10 px-6 md:px-[69px] rounded-lg w-full max-w-md md:max-w-[610px]">
